...
public class DBOperations extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "product_info.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(ProductContacts.ProductEntry.CREATE_QUERY);
    ...
    public void addInformations(SQLiteDatabase db, String id, String name, int price, int qty) {
        ...
        contentValues.put(ProductContacts.ProductEntry.ID, id);
        contentValues.put(ProductContacts.ProductEntry.NAME, name);
        contentValues.put(ProductContacts.ProductEntry.PRICE, price);
        contentValues.put(ProductContacts.ProductEntry.QTY, qty);

        db.insert(ProductContacts.ProductEntry.TABLE_NAME, null, contentValues);
